...
_sage_const_0 = Integer(0); _sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_5 = Integer(5); _sage_const_8 = Integer(8); _sage_const_448 = Integer(448)
...
n = _sage_const_5  #Número de bits
L = n + _sage_const_1 
lamba = _sage_const_8  # parâmetro de segurança
dghv = DGHV(_sage_const_448 , _sage_const_2 **(n+_sage_const_1 ) * _sage_const_8 , _sage_const_8 , L)
compIguais(dghv, n)
